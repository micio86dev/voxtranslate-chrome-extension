  ...
  <main class="panel">
    ...
    <template v-else>
      ...
      <section class="card">
        ...
        <!-- AI Act Art. 50(1)+(5): shown before the user can start a session, so the
             disclosure precedes the first exposure to AI-generated subtitles and voice.
             Kept OUTSIDE the v-if/v-else pair below — see the warning there. -->
        <p class="fine">
          Subtitles and any translated voice are generated by AI and may contain errors. The
          translated voice is synthesized — it is not a recording of the speaker.
        </p>
